...
public class BanglaTribune_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                prothomalowebview.loadUrl("https://www.banglatribune.com/");
            }
        });
                ...
                builder.setMessage("Do you want to Exit?")
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                Intent intent = new Intent(BanglaTribune_Activity.this,MainActivity.class);
...
//Back Button Ends
    ...
    public void checkConnection(){
        ...
        if (null!=activeNetwork){
            ...
            Intent intent = new Intent(BanglaTribune_Activity.this,Checkconnection.class);
            startActivity(intent);
        }
    }
